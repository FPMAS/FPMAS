...
namespace FPMAS {
	namespace graph {
		...
		template<class T> void zoltan_obj_size_multi_fn(
				void *, int, int, int, ZOLTAN_ID_PTR, ZOLTAN_ID_PTR, int *, int *
				); 

		template<class T> void zoltan_pack_obj_multi_fn(
				void *, int, int, int, ZOLTAN_ID_PTR, ZOLTAN_ID_PTR, int *, int *, int *, char *, int *
				);

		template<class T> class DistributedGraph : public Graph<T> {
			friend void zoltan_obj_size_multi_fn<T>(
				void *, int, int, int, ZOLTAN_ID_PTR, ZOLTAN_ID_PTR, int *, int *); 
			friend void zoltan_pack_obj_multi_fn<T>(
				void *, int, int, int, ZOLTAN_ID_PTR, ZOLTAN_ID_PTR, int *, int *, int *, char *, int *
				);
		...
		template<class T> DistributedGraph<T>::DistributedGraph(Zoltan* z)
			: Graph<T>(), zoltan(z) {
				...
				zoltan->Set_Obj_Size_Multi_Fn(FPMAS::graph::zoltan_obj_size_multi_fn<T>, this);
				zoltan->Set_Pack_Obj_Multi_Fn(FPMAS::graph::zoltan_pack_obj_multi_fn<T>, this);
