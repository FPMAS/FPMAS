 ...
 */
std::string SyncMpiCommunicator::read(IdType id, int location) {
 ...
 * queue otherwise.
 */
void SyncMpiCommunicator::handleRead(int destination, IdType id) {
 ...
 * resourceManager.
 */
void SyncMpiCommunicator::respondToRead(int destination, IdType id) {
 ...
 */
std::string SyncMpiCommunicator::acquire(IdType id, int location) {
	if(location == this->getRank()) {
 ...
 * queue otherwise.
 */
void SyncMpiCommunicator::handleAcquire(int destination, IdType id) {
	this->color = Color::BLACK;
 ...
 * resourceManager.
 */
void SyncMpiCommunicator::respondToAcquire(int destination, IdType id) {
	std::string data = this->resourceContainer.getLocalData(id);
 ...
 * @param location rank of the data location
 */
void SyncMpiCommunicator::giveBack(IdType id, int location) {
	if(location == this->getRank()) {
